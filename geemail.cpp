...
//All clases for storing data from DB
struct MyData {
...
//All helping function's declarations 
...
//   }
   ...
   //printf("this is the value count= %s .",argv[0][0]);
   return 0;
}
static string HexOfPass(string password,int salt){
...
static void logins(){
    ...
    {
    std::cerr << "Error: password can't have special characters.\n\n";
    exit(0);
    }
...
string choice;
    while (1){
        ...
        cout << "║  2- check your inbox.                                         ║" << endl;
        cout << "║  3- check your outbox.                                        ║" << endl;
        ...
        cout << "▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓" << endl;
        cout << " ┌──────────────────────────────────────────────────────────────┐"<< endl;
        cout << "  "+username+" please enter one of the options:"<< endl;
        cout << " └──────────────────────────────────────────────────────────────┘"<< endl;
        cin >> choice;
        cin.ignore();
        if (isdigit(choice[0]) && (choice=="1")){
            ...
            int i=search_in(sql1);
            if (i==0){
                cout<<"ALERT: You have no messages in your inbox."<<endl;
                app_menu(username);
            }
            ...
            int i=search_in(sql1);
            if (i==0){
                cout<<"ALERT: You have no messages in your outbox."<<endl;
                app_menu(username);
            }
            //... all other constraints  to username password key places here
            else{
            ...
            cout << "Error: Enter a valid choice from the menu.\n\n" << endl;
        }
    }
...
static void send_message(string username){
    ...
    cout << "▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓"<<endl;
    cout << " ┌──────────────────────────────────────────────────────┐"<< endl;
    cout << "  "+username+" please enter the subject:" << endl;
    cout << " └──────────────────────────────────────────────────────┘"<< endl;
    getline (cin,subject);
    if (subject.find_first_not_of(" abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890_,.?!") != std::string::npos)
    {
    std::cerr << "Error: subject can't have special characters.\n\n";
    exit(0);
    }
    cout << " ┌──────────────────────────────────────────────────────┐"<< endl;
    cout << "  "+username+" please enter the content:" << endl;
    cout << " └──────────────────────────────────────────────────────┘"<< endl;
    //cin.ignore();
    getline(cin,content);
    ...
    cout << " ┌──────────────────────────────────────────────────────┐"<< endl;
    cout << "  "+username+" please enter the receiver's name:" << endl;
    cout << " └──────────────────────────────────────────────────────┘"<< endl;
    cin >> to;
    ...
    if (i==0){
        cout<<"\nError: Sorry we couldn't find that username on our database. You can only send messages to a registed user."<<endl;
        ...
        i=insert_query(sql);
        cout<<"._.o0o("+username+" Your email has been sent to "+to+" !)o0o._.\n"<<endl;
        app_menu(username);
...
for (int index = 0; index < inData.size(); ++index)
{
    cout << (index+1)<<"- SUBJECT:"<<inData[index].subject<<"\tFROM:"<<inData[index].sname<<"\tDATE:"<<inData[index].date<<"\tTIME:"<<inData[index].stime<<endl; 
        ...
        cout << "▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓" << endl;
        cout << " ┌──────────────────────────────────────────────────────────────┐"<< endl;
        cout << " |Please enter the # of a message to expand it or E to exit     | "<< endl;
        cout << " └──────────────────────────────────────────────────────────────┘"<< endl;
        cin >> choice;
